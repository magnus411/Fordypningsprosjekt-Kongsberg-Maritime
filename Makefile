...
RELEASE_SDB_FLAGS = -DSDB_LOG_LEVEL=0 -DSDB_MEM_TRACE=0 -DSDB_PRINTF_DEBUG_ENABLE=0 -DSDB_ASSERT=0
...
release: CFLAGS = $(RELEASE_FLAGS) $(RELEASE_SDB_FLAGS) $(DB_SYSTEMS) $(COMM_PROTOCOLS)
release: build_main
